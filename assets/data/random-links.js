window.randomLinks = [
  {
    title: "SPOT: Treebank-Driven Approach to the Study of Spoken Slovenian",
    url: "https://spot.ff.uni-lj.si/",
    desc: "A treebank-driven approach to studying spoken Slovenian where I contributed a small piece to the puzzle."
  },
  {
    title: "Online Notes",
    url: "https://www.cjvt.si/online-notes/",
    desc: "A promising project aimed at improving lecture accessibility via real-time transcription and translation. Foreign students could follow lectures in their language, while native speakers would benefit from automated note-taking."
  },
  {
    title: "DigLing Subjects at FRI – Feedback Form",
  ...
  {
    title: "Word Order Variation in Spoken and Written Corpora: A Cross-Linguistic Study of SVO and Alternative Orders (SyntaxFest 2025)",
    url: "https://aclanthology.org/2025.depling-1.16/",
    desc: "A little self-promotion never hurt anyone: my paper was accepted at SyntaxFest 2025! If you want to see what I've been up to (or just want to support shameless self-advertising), check it out here."
  },
  {
